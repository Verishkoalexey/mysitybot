package by.verishko.mysitybot.botapi;

import by.verishko.mysitybot.cache.UserDataCache;
import by.verishko.mysitybot.service.MainMenuService;
...
public class TelegramFacade {
    ...
    private SendMessage handleInputMessage(Message message) {
        ...
        switch (inputMsg) {
            case "/start":
                ...
                break;
            case "Поиск информации о городе":
                botState = BotState.SEARСH_PROFILE;
                break;
            case "Моя анкета":
    ...
    private BotApiMethod<?> processCallbackQuery(CallbackQuery buttonQuery) {
        ...
        if (buttonQuery.getData().equals("buttonYes")) {
            callBackAnswer = new SendMessage(chatId, "Введите город ?");
